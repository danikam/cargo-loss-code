...
def get_pathway_type(pathway, info_file=None):
    ...
    if info_file is None:
        top_dir = get_top_dir()
        info_file = f"{top_dir}/data/pathway_info.csv"
...
def get_pathway_type_color(pathway_type, info_file=None):
    if info_file is None:
        top_dir = get_top_dir()
        info_file = f"{top_dir}/data/pathway_type_info.csv"
...
def read_pathway_labels():
    ...
    """
    top_dir = get_top_dir()
    pathway_labels_df = pd.read_csv(f"{top_dir}/data/pathway_info.csv").set_index(
        "Pathway Name"
    )
...
def read_fuel_labels():
    ...
    """
    top_dir = get_top_dir()
    fuel_labels_df = pd.read_csv(f"{top_dir}/data/fuel_info.csv").set_index(
        "Fuel"
    )
